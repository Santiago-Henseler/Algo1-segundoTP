...
void imprimir_terreno(juego_t juego){
    ...
    // cargamos todas las posiciones en la matriz terreno
...
void realizar_jugada(juego_t* juego, char movimiento){
  ...
  // MODULARIZAR CREACION DEL TERRENO
  // 